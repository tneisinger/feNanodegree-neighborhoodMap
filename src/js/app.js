  ...
  self.initMap = function() {
    ...
    places.forEach(function(place) {
      ...
      place.marker.infowindow.addListener('domready', function() {
        ...
        // Hide certain ugly divs that generated by the google maps API
       ...
       // to 'pointer-events: auto'.)
        ...
        iwCloseTransparent.css({
          ...
          // from briefly appearing in chrome for android. Without these rules,
          // the blue square will appear whenever an info window's close button
          // is tapped.
